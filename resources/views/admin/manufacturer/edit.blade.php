...
<div class="row-fluid sortable ui-sortable">
				<div class="box blue span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Create Manufacturer</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" action="{{route('manufacture.store)}}" method="post">
							<fieldset>
							  ...
							  <div class="control-group ">
								<label style="color:black" class="control-label" for="prependedInput">manufacturer_name	</label>
								<div class="controls">
